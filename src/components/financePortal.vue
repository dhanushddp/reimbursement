<template>
  <div>
    ...
    <div>
      <div class="addClaimContainer">
        <div class="addClaim">
          <b-button style="margin-right: 10px" v-b-modal.modal-center31
            >Add Claim</b-button
          >
        </div>
      </div>
      ...
      <div class="claimContainer">
        ...
        <div class="myClaims">
          <ul class="responsive-table">
            ...
            <li
              v-if="retrieveFinanceClaims.length == 0"
            ...
            <li
              class="table-row cen"
              v-for="(claim, index) in retrieveFinanceClaims"
              :key="index"
            >
              ...
              <div class="col col-7" data-label="Actions">
                ...
                ></i>
                 <i
                  @click="deleteFinanceRequest(claim)"
                  style="padding-left: 20px; cursor: pointer"
          ...
          <div class="container mt-5">
            <div>
              <b-modal id="modal-center31" centered title="Add Claim here">
                <form>
          ...
          <div class="container mt-5">
            <div>
              <b-modal id="modal-center42" centered title="View Claim Here...">
                <form>
                  <div class="form-group">
      ...
      <div class="claimContainer">
        ...
        <div class="myClaims">
          <ul class="responsive-table">
            ...
            <li
              v-if="retrieveFinanceTeamClaims.length == 0"
              style="justify-content: center"
              class="table-row"
            >
              No data Found
            ...
            <li
              class="table-row cen"
              v-for="(claim, index) in retrieveFinanceTeamClaims"
               :key="index"
            >
              <div class="col col-1" data-label="ClaimId">
              ...
              >
               ...
               <div class="col col-7" data-label="Actions">
                ...
                ></i>
                <i
                  @click="deleteFinanceTeamRequest(claim)"
                  style="padding-left: 20px; cursor: pointer"
                  class="fa fa-trash-o fa-2x"
                  aria-hidden="true"
                ></i>
                ...
                >
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      <label for="name" style="padding-left: 10px"
            ...
            <div class="container mt-5">
              <div>
                <b-modal id="modal-center33" centered title="Comment Here...">
                  <form>
                    <div class="form-group">
  ...
  <script src="../scripts/financePortal.js">
</script>
  
  <style scoped>
@import url("../css/financePortal.css");
</style>
