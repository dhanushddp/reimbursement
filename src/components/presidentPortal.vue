<template>
  <div>
    ...
    <div>
      <div class="addClaimContainer">
        <div class="addClaim">
          <b-button style="margin-right: 10px" v-b-modal.modal-center61
            >Add Claim</b-button
          >
        </div>
      </div>
      ...
      <div class="claimContainer">
        ...
        <div class="myClaims">
          <ul class="responsive-table">
            ...
            <li
              v-if="retrievePresidentClaims.length == 0"
            ...
            <li
              class="table-row cen"
              v-for="(claim, index) in retrievePresidentClaims"
              :key="index"
            >
              ...
              <div class="col col-7" data-label="Actions">
                ...
                <i
                  ...
                  v-b-modal.modal-center62
                  aria-hidden="true"
                ></i>
                <i
                  @click="deletePresidentRequest(claim)"
                  style="padding-left: 20px; cursor: pointer"
          ...
          <div class="container mt-5">
            <div>
              <b-modal id="modal-center61" centered title="Add Claim here">
                <form>
          ...
          <div class="container mt-5">
            <div>
              <b-modal id="modal-center63" centered title="Comment Here...">
                <form>
                  <div class="form-group">
          ...
          <div class="container mt-5">
            <div>
              <b-modal id="modal-center62" centered title="View Claim Here...">
                <form>
                  <div class="form-group">
      ...
      <div class="claimContainer">
        ...
        <div class="myClaims">
          <ul class="responsive-table">
            ...
            <li
              v-if="retrievePresidentTeamClaims.length == 0"
              style="justify-content: center"
              class="table-row"
            >
              No data Found
            ...
            <li
              class="table-row cen"
              v-for="(claim, index) in retrievePresidentTeamClaims"
              :key="index"
            >
              <div class="col col-1" data-label="ClaimId">
              ...
              >
               ...
               <div class="col col-7" data-label="Actions">
                ...
                <i
                  ...
                  style="padding-left: 20px; cursor: pointer"
                  class="fa fa-eye fa-2x"
                  v-b-modal.modal-center64
                  aria-hidden="true"
                ></i>
                <i
                  @click="deletePresidentTeamRequest(claim)"
                  style="padding-left: 20px; cursor: pointer"
                  class="fa fa-trash-o fa-2x"
                  aria-hidden="true"
                ></i>
          ...
          <div class="container mt-5">
            <div>
              <b-modal id="modal-center64" centered title="View Claim Here...">
                <form>
                  <div class="form-group">
  ...
  <script src="../scripts/presidentPortal.js">
</script>
  
  <style scoped>
@import url("../css/presidentPortal.css");
</style>
