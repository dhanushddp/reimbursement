<template>
    ...
    <div>
        ...
        <div class="myClaims">
          <ul class="responsive-table">
            <li class="table-header">
              <div class="col col-1">ClaimId/Name</div>
      ...
      <div class="header">Team's   Claims</div>

      <div class="claimContainer">
        <div class="filter">
          <div class="All" @click="showAll1()">ALL</div>
           <div class="Pending" @click="showPending1()">PENDING</div>
          <div class="accepted" @click="showApproved1()">APPROVED</div>
          <div class="rejected" @click="showRejected1()">REJECTED</div>
        </div>
         <hr
          style="
            color: black;
        ...
        'green1': claim.statusOfApprovers[1].status=='APPROVED',}">{{(claim.statusOfApprovers[1].status)}}</div>
          ...
          ></i>
            ...
            <div class="container mt-5">
            <div>
              <b-modal id="modal-center11" centered title="View Claim Here...">
                <form>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                       <button @click="approve()" id="approve1" type="button" style="background-color:#07a65b;border:none;padding: 10px 10px 10px 10px;color: white;">Approve</button>
                  </div>
                  <div class="form-group">
                       <button @click="reject()" type="button" style="background-color:#ff4d3d;border:none;padding: 10px 10px 10px 10px;color: white;">Reject</button>
                  </div>
...
<script src="../scripts/managerPortal.js">
</script>
...
@import url('../css/managerPortal.css');
</style>